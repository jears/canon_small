...
public class RunList {
	...
	private static String dir = teamID + "-INTENT2-eval/";
	/**
	...
	public static void main(String[] args) throws IOException {
		...
		test.getDes("./run/des.txt");
		List<String> oldfiles = new ArrayList<String>();
		oldfiles.add("./run/NTCIR10EnRun1_0729.txt");
		oldfiles.add("./run/NTCIR10EnRun2_0729.txt");
		oldfiles.add("./run/NTCIR10EnRun2_0729_freebase.txt");
